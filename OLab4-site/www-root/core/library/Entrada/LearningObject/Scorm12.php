...
class Entrada_LearningObject_Scorm12 extends Entrada_LearningObject_Scorm {
    ...
    public function load() {
        ...
        try {
            ...
            application_log("error", "Error loading SCORM 1.2 file: " . $e->getMessage());
        }
