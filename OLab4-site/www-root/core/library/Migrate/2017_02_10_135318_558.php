<?php
class Migrate_2017_02_10_135318_558 extends Entrada_Cli_Migrate {
    ...
    public function audit() {
        ...
        if ($column_info && $column_info == "ENUM('delegator_start','delegator_late','assessor_start','assessor_reminder','assessment_approver','assessor_late','flagged_response','assessment_removal','assessment_task_deleted','delegation_task_deleted','assessment_submitted','assessment_delegation_assignment_removed','assessment_submitted_notify_approver','assessment_submitted_notify_learner')") {
            return 1;
        } else {
            return 0;
        }
