<?php
class Migrate_2016_08_24_155601_1072 extends Entrada_Cli_Migrate {
    ...
    public function up() {
        $this->record();
        ?>
        CREATE TABLE `<?php echo DATABASE_NAME; ?>`.`course_linked_objectives` (
    ...
    public function down() {
        $this->record();
        ?>
        DROP TABLE `<?php echo DATABASE_NAME; ?>`.`course_linked_objectives`;
        <?php
        $this->stop();
    ...
    public function audit() {
        ...
        if ($migration->tableExists(DATABASE_NAME, "course_linked_objectives")) {
            return 1;
        } else {
            return 0;
        }
