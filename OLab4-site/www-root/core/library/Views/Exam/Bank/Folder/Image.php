...
class Views_Exam_Bank_Folder_Image extends Views_Deprecated_Base
{
    ...
    protected $table_name = "exam_lu_bank_folder_images";
    protected $primary_key = "image_id";
    protected $default_sort_column = "`exam_lu_bank_folder_images`.`order`";
    protected $joinable_tables = array();
    protected $image;

    public function __construct(Models_Exam_Lu_Bank_Folder_Images $image) {
        $this->image = $image;
    }
