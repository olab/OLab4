...
class Views_Exam_Bank_Folder_Author extends Views_Deprecated_Base
{
    ...
    protected $table_name = "exam_bank_folder_authors";
    protected $primary_key = "efauthor_id";
    protected $default_sort_column = "`exam_bank_folder_authors`.`efauthor_id`";
    protected $joinable_tables = array();
    protected $author;

    public function __construct(Models_Exam_Bank_Folder_Authors $author) {
        $this->author = $author;
    }
