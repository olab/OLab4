		...
		if ($incident_record) {
			...
			switch ($STEP) {
				...
				default :
					...
					?>
					<form action="<?php echo ENTRADA_URL; ?>/admin/users/manage/incidents?section=edit&amp;id=<?php echo $PROXY_ID; ?>&amp;incident-id=<?php echo $incident_id; ?>&amp;step=2" method="post" class="form-horizontal">
