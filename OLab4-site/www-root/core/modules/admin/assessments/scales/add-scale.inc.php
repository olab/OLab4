...
if ((!defined("PARENT_INCLUDED")) || (!defined("IN_SCALES"))) {
    ...
    define("ADD_SCALE", true);
    $BREADCRUMB[] = array("url" => ENTRADA_URL."/admin/assessments/scales/" . $SECTION, "title" => $translate->_("Add Rating Scale"));
    ...
    $scale = new Models_Assessments_RatingScale();
    $PROCESSED = $scale->toArray();
    $METHOD = "insert";
    $scale_data = array();
    ?>
    <h1><?php echo $translate->_("Create New Rating Scale"); ?></h1>
    <?php
