...
if ((!defined("PARENT_INCLUDED")) || (!defined("IN_ASSESSMENTS"))) {
    ...
    <script type="text/javascript">
        jQuery(function($) {
            ...
            $("#choose-evaluation-btn").advancedSearch({
                ...
                no_results_text: "<?php echo $translate->_("no_course_found_matching_the_search_criteria"); ?>",
    ...
    <form class="form-horizontal" id="evaluation-form">
        ...
        <div class="control-group <?php echo is_null($start_date) && is_null($end_date) ? "hide" : ""; ?> " id="evaluation-search">
            <label class="control-label" for="choose-evaluation-btn"><?php echo $translate->_("select_course") . ":"; ?></label>
            <div class="controls">
                <a href="#" id="choose-evaluation-btn" class="btn" type="button"><?php echo $translate->_("browse_course") . " "; ?><i class="icon-chevron-down"></i></a>
            </div>
        </div>
