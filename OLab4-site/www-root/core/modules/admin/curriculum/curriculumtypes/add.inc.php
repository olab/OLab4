...
if (!defined("PARENT_INCLUDED") ) {
	...
	$BREADCRUMB[] = array("url" => ENTRADA_URL."/admin/curriculum/curriculumtypes?".replace_query(array("section" => "add"))."&amp;org=".$ORGANISATION_ID, "title" => "Add");
					...
					if ($TYPE_ID = $db->Insert_Id()) {
						...
						if ($db->AutoExecute("curriculum_type_organisation", $params, "INSERT")) {
							...
							$ONLOAD[] = "setTimeout('window.location=\\'".$url."\\'', 5000)";
								...
								$url = ENTRADA_URL . "/admin/curriculum/curriculumtypes?section=edit&org=".$ORGANISATION_ID."&type_id=".$TYPE_ID;
	...
	switch ($STEP) {
        ...
        <form class="form-horizontal" action="<?php echo ENTRADA_URL."/admin/curriculum/curriculumtypes"."?".replace_query(array("action" => "add", "step" => 2))."&org=".$ORGANISATION_ID; ?>" id="curriculum_form" method="post">
            ...
            <div class="pull-right">
                <button type="button" class="btn" onclick="window.location='<?php echo ENTRADA_URL; ?>/admin/curriculum/curriculumtypes?org=<?php echo $ORGANISATION_ID;?>'"><?php echo $translate->_("global_button_cancel"); ?></button>
