...
if ((!defined("PARENT_INCLUDED")) || (!defined("IN_CURRICULUM_MAP_VERSIONS"))) {
    ...
    $BREADCRUMB[] = array("url" => ENTRADA_RELATIVE . "/admin/curriculum/curriculummapversions?section=add&org=" . $ORGANISATION_ID, "title" => $translate->_("Add"));

    echo "<h1>".$translate->_("Add Curriculum Map Version")."</h1>";

    define("ADD_MAP_VERSION", true);
