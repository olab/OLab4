...
if ((!defined("PARENT_INCLUDED")) || (!defined("ADD_FOLDER") && !defined("EDIT_FOLDER"))) {
    ...
    switch ($STEP) {
        case 2 :
            ...
            if ($PROCESSED["folder_id"] === $PROCESSED["parent_folder_id"]) {
                add_error($translate->_("You can't make a folder its own parent. Please chose a different parent folder."));
            }
            ...
            if (!has_error()) {
                ...
                if ($folder->{$METHOD}()) {
                    if ($METHOD == "update") {
                        ...
                        $success_msg = sprintf($translate->_("The folder has been successfully added. You will be redirected to the exams bank index, please <a href=\"%s\">click here</a> if you do not wish to wait. <br><br>If you wish to add authors to the folder, please click <a href=\"%s\">here</a>."), $url, $edit_folder_url);
                    }
    ...
    switch ($STEP) {
        ...
        default:
            ...
            $initial_folders = Models_Exam_Bank_Folders::fetchAllByParentID($PROCESSED["parent_folder_id"], "exam");
            ...
            $HEAD[] = "<script type=\"text/javascript\" src=\"" . ENTRADA_URL . "/javascript/exams/exams/folders.js?release=". html_encode(APPLICATION_VERSION) ."\"></script>";
            ...
            <form id="question-exam-folder" action="<?php echo ENTRADA_URL . "/admin/" . $MODULE . "/" . $SUBMODULE . "?step=2&section=" . $SECTION . ($METHOD == "update" ? "&id=" . $PROCESSED["folder_id"] : ""); ?>" class="form-horizontal" method="POST">
                ...
                <div class="control-group">
                    <label class="control-label form-required" for="parent_folder_id"><?php echo $translate->_("Parent Folder") ?></label>
                    <div class="controls">
            ...
            <div id="parent-folder-modal" class="modal hide fade">
                ...
                <div class="modal-body">
                    <div class="qbf-selector">
                        ...
                        <div id="qbf-folder-<?php echo (int) $PROCESSED["parent_folder_id"];?>" class="qbf-folder active">
                            <table>
                                <?php
