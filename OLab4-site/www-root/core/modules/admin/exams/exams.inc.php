...
if (!defined("PARENT_INCLUDED")) {
    ...
    $BREADCRUMB[] = array("url" => ENTRADA_URL."/admin/" . $MODULE . "/" . $SUBMODULE, "title" => $translate->_("Exams"));
    ...
    <script type="text/javascript">
        var submodule_text      = <?php echo json_encode($SUBMODULE_TEXT); ?>;
        var default_text_labels = <?php echo json_encode($DEFAULT_TEXT_LABELS); ?>;
    </script>
<?php    
}