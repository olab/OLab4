		...
		if (isset($ORGANISATION_ID) && $ORGANISATION_ID) {
			...
			if ($ORGANISATION) {
				if ($ENTRADA_ACL->amIAllowed(new ConfigurationResource($ORGANISATION_ID),"read")) {
                    ...
                    $sidebar_html .= "	<li class=\"link\"><a href=\"".ENTRADA_URL."/admin/settings/manage/flags?org=".$ORGANISATION_ID."\">" . $translate->_("Assessment Flag Severity") . "</a></li>\n";
                    ...
                    $sidebar_html .= "	<li class=\"link\"><a href=\"".ENTRADA_URL."/admin/curriculum/curriculumtypes?org=".$ORGANISATION_ID."\"><i class=\"fa fa-external-link\" aria-hidden=\"true\"></i> Curriculum Layout</a></li>\n";
                    $sidebar_html .= "	<li class=\"link\"><a href=\"".ENTRADA_URL."/admin/curriculum/curriculumtracks?org=".$ORGANISATION_ID."\"><i class=\"fa fa-external-link\" aria-hidden=\"true\"></i> Curriculum Tracks</a></li>\n";
                    $sidebar_html .= "	<li class=\"link\"><a href=\"".ENTRADA_URL."/admin/curriculum/tags\"><i class=\"fa fa-external-link\" aria-hidden=\"true\"></i> Curriculum Tags</a></li>\n";
                    ...
                    //$sidebar_html .= "	<li class=\"link\"><a href=\"".ENTRADA_URL."/admin/settings/manage/honorcode?org=".$ORGANISATION_ID."\">" . $translate->_("Honor Code") . "</a></li>\n";
                    ...
                    $sidebar_html .= "	<li class=\"link\"><a href=\"".ENTRADA_URL."/admin/settings/manage/disclaimers?org=".$ORGANISATION_ID."\">" . $translate->_("User Disclaimers") . "</a></li>\n";
