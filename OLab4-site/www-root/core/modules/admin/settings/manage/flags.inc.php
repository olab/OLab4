 ...
 *
 * Primary controller file for the Flag severities module.
 * /admin/settings/manage/flags
 *
...
$BREADCRUMB[] = array("url" => ENTRADA_URL."/admin/settings/manage/flags?org=".$ORGANISATION_ID, "title" => $translate->_("Flag Severities"));
...
if (!defined("PARENT_INCLUDED") || !defined("IN_CONFIGURATION")) {
    ...
    if (($router) && ($router->initRoute())) {
         ...
         */
        if (isset($_GET["flag"]) && ($flag = clean_input($_GET["flag"], array("notags", "trim")))) {
            $FLAG_ID = $flag;
        }
