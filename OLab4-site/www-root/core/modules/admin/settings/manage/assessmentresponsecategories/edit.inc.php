...
if ((!defined("PARENT_INCLUDED")) || (!defined("IN_ASSESSMENT_RESPONSE_CATEGORIES"))) {
    ...
    $BREADCRUMB[] = array("url" => ENTRADA_URL."/admin/settings/manage/assessmentresponsecategories?section=edit&id=".$RECORD_ID."&org=".$ORGANISATION_ID, "title" => $translate->_("Edit Response Category"));

    echo "<h1>".$translate->_("Edit Assessment Response Category")."</h1>";

    define("EDIT_ASSESSMENT_RESPONSE_CATEGORY", true);
