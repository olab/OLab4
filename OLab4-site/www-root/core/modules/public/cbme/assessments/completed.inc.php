...
if(!defined("PARENT_INCLUDED")) {
    ...
    $cbme_progress_api = new Entrada_CBME_Visualization(array(
        ...
        "filters" => $_GET,
        "query_limit" => 12,
        "limit_dataset" => array("assessments", "total_assessment_count", "filtered_assessment_count", "unread_assessment_count", "course_epas", "roles", "course_milestones", "course_assessment_tools", "rating_scales", "filter_list_data", "course_stages"),
        "courses"  => $courses,
