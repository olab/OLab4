 ...
 *
 * This section is a secure wrapper which loads the exam attempt interface
 *
...
$access_file = Models_Secure_AccessFiles::fetchAllByResourceTypeResourceID("exam_post", $RECORD_ID);
/**
 * Validate Keys
 */
$grant_access = false;
if ($access_file) {
    $access_keys = Models_Secure_AccessKeys::fetchAllByResourceTypeResourceID("exam_post", $RECORD_ID);
...
if (true === $grant_access) {
    ...
    require_once(ENTRADA_ABSOLUTE . "/core/modules/public/exams/attempt.inc.php");
} else {
