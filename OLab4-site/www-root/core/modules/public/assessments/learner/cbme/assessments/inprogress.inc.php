    ...
    if (!$ERROR) {
        ...
        if ($learner) {
            ...
            $cbme_assessments_view->render(array(
                ...
                "form_action_url" => ENTRADA_URL . "/assessments/learner/cbme/assessments/inprogress?proxy_id=" . html_encode($PROCESSED["proxy_id"]),
                "form_reset_url" => ENTRADA_URL . "/assessments/learner/cbme/assessments/inprogress?proxy_id=" . html_encode($PROCESSED["proxy_id"]),
