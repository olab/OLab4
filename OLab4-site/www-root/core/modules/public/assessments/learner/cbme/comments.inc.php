    ...
    if (!$ERROR) {
        ...
        if ($learner) {
            ...
            $cbme_assessment_comments_view->render(array(
                ...
                "form_action_url" => ENTRADA_URL . "/assessments/learner/cbme/comments?proxy_id=" . html_encode($PROCESSED["proxy_id"]),
                "form_reset_url" => ENTRADA_URL . "/assessments/learner/cbme/comments?proxy_id=" . html_encode($PROCESSED["proxy_id"]),
