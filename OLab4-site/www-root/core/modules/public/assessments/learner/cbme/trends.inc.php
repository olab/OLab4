        ...
        */
        ...
        if ($learner) {
            ...
            $cbme_trends_view->render(array(
                ...
                "form_action_url" => ENTRADA_URL . "/assessments/learner/cbme/trends?proxy_id=" . html_encode($PROCESSED["proxy_id"] ? $PROCESSED["proxy_id"] : $ENTRADA_USER->getActiveId()),
                "form_reset_url" => ENTRADA_URL . "/assessments/learner/cbme/trends?proxy_id=" . html_encode($PROCESSED["proxy_id"] ? $PROCESSED["proxy_id"] : $ENTRADA_USER->getActiveId()),
