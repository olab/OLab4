...
if((!defined("PARENT_INCLUDED")) || (!defined("IN_ANNUAL_REPORT"))) {
	...
	$BREADCRUMB[]	= array("url" => "", "title" => "Undergraduate Non-Medical Teaching for ".$departmentOuput);
	...
	if(isset($years["start_year"]) && $years["start_year"] != "") {
		...
		if ($STEP == 2) {
			...
			if ($results) {
				echo "<h2>Annual Report Undergraduate Non-Medical Education data for " . $departmentString."</h2>";
