let control_flow = {
    ...
    "generate": {
        ...
        api_params: {                       // API params will be stored over the course of data selection for final submission.
            "target_type": "course_id",     // Target type is course.
    ...
    function configureDependantControls(control) {
        ...
        switch (control) {
            case "course":
                ...
                // Target type is course.
                setAdvancedSearchApiParameter("form", "form", "target_type", "course_id");
                setAdvancedSearchApiParameter("distribution", "distribution", "target_type", "course_id");

                // Filter the form and distribution data set to the target courses chosen.
                setAdvancedSearchApiParameter("form", "form", "target_ids", course_ids);
                setAdvancedSearchApiParameter("distribution", "distribution", "target_ids", course_ids);

                submission_values["course_ids"] = course_ids;
                // Courses are the final targets for this report.
                submission_values["target_ids"] = course_ids;
            ...
            case "form":
                ...
                configureDependantControls("distribution");
