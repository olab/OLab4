...
if ((!isset($_SESSION["isAuthorized"])) || (!$_SESSION["isAuthorized"])) {
    ...
    <head>
        ...
        <link href="<?php echo ENTRADA_URL; ?>/css/filebrowser.css?release=<?php echo html_encode(APPLICATION_VERSION); ?>" rel="stylesheet" type="text/css" media="all" />
        ...
        <script src="<?php echo ENTRADA_URL; ?>/javascript/jquery/jquery.dataTables.min.js?release=<?php echo html_encode(APPLICATION_VERSION); ?>"></script>
        <?php
        load_rte();
        ?>
        <script>
        ...
        <script src="<?php echo ENTRADA_URL; ?>/javascript/filebrowser.js?release=<?php echo html_encode(APPLICATION_VERSION); ?>"></script>
    </head>
    <body>
    <?php
        ...
        <div class="row file-browser-panel">
            <div class="row-fluid toolbar">
                <div id="dropzone" class="span12 space-below">
                    <h3>Upload Files</h3>
                    <p class="event-resource-upload-text">You can drag and drop files into this window to
                        upload. If you wish you can also use the browse button below to upload files.</p>
                    <?php
                    if (has_error()) {
