...
var OlabMapList=function(params) {
      ...
      'columns': [
          ...
          { 'title': 'Abstract' },
          {
            ...
            'render': function (data, type, full, meta) {
              ...
              var html = '<a title="Map Info" onclick="view.showDetail(this);" class="btn btn-primary"><i class="fa fa-info-circle"></i></a> ';
              html += '<a title="Play" onclick="view.play(' + full[3] + ',0 )" class="btn btn-primary"><i class="fa fa-play"></i></a> ';

              if(typeof full[4] !== "undefined") {
                html += '<a title="Resume from Checkpoint" onclick="view.play(' + full[3] + ',' + full[4]["map_node_id"] + ')" class ="btn btn-primary"><i class ="fa fa-pause"></i></a>';
              }
  ...
  /**
   * Hanlde Map list load server call failure
   * @param {} data 
   * @returns {} 
   */
  ...
  function play(mapId, nodeId) {
    var url = vm.moduleUrl + "/play#" + mapId + ":" + nodeId;
  ...
  function showDetail(name) {
    ...
    try {
      ...
      var url = vm.restApiUrl + '/info/' + data[0];
