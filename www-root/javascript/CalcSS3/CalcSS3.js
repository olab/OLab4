(function(window) {
	...
	function render(val, inp) {
		...
		if (ln) {
			/* Hard coded the display US style of commas and periods
			  - Sam Payne 10-20-2016
			 */
			ln = 2;
			tmp = tmp.replace(/\./g, '#').
		...
		displayStyle.fontSize = '25px';
		displayParentStyle.lineHeight = '61px';

		/*
		This section was causing errors - Sam Payne 10-19-2016
	...
	function doKey(text, alt) {
		...
		if (document.activeElement) {
			var input_type = document.activeElement.tagName;
			if (input_type != "BODY") {
