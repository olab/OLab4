...
class PatientScenario extends BaseModel {

    protected $table = 'patient_scenario';
    protected $fillable = ['id_patient','id_scenario'];
    protected $validations = ['id_patient' => 'exists:patient,id|integer|required',
                            'id_scenario' => 'exists:webinars,id|integer|required'];

    public function Patient() {
        return $this->belongsTo('App\Modules\Olab\Models\Patient');
    }
