...
class Webinars extends BaseModel {
    ...
    public function ConditionsAssign() {
        return $this->hasMany('App\Modules\Olab\Models\ConditionsAssign');
    }
    public function ConditionsAssign() {
        return $this->hasMany('App\Modules\Olab\Models\ConditionsAssign');
    }
    ...
    public function PatientScenario() {
        return $this->hasMany('App\Modules\Olab\Models\PatientScenario');
    }
    public function PatientSessions() {
        return $this->hasMany('App\Modules\Olab\Models\PatientSessions');
    }
