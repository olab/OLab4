 ...
 *
 * View class for rendering selectbox (single select) form element.
 *
...
class Views_Assessments_Forms_Items_SelectboxSingle extends Views_Assessments_Forms_Items_Base {
    ...
    protected function renderError() {
        ...
        <div class="alert alert-danger">
            <strong><?php echo $translate->_("Unable to render select box form item"); ?></strong>
        </div>
        <?php
    }
