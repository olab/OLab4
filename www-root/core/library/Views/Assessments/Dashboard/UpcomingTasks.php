 ...
 *
 * View class for rendering the upcoming assessments, appended
 ...
 *
 */
class Views_Assessments_Dashboard_UpcomingTasks extends Views_Assessments_Base {
    ...
    protected function renderView($options = array()) {
        ...
        <div class="row-fluid space-above space-below">
            <button class="btn disabled pull-left task-btn <?php echo html_encode($options["task_type"]); ?>-upcoming-tasks-previous"><i class="icon-chevron-left"></i> <?php echo $translate->_("Previous"); ?></button>
            <button class="btn space-left pull-left task-btn <?php echo html_encode($options["task_type"]); ?>-upcoming-tasks-next"><?php echo $translate->_("Next"); ?> <i class="icon-chevron-right"></i></button>
