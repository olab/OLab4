    ...
    protected function renderView($options = array()) {
        ...
        <div class="tab-content tasks-tabs">
            <?php foreach ($task_types as $task_type) : ?>
                <div class="tab-pane fixed-tab-height <?php echo $task_type == "assessment" ? "active" : ""; ?>" id="<?php echo $task_type; ?>-tab-pane">
                    <div class="half-wrapper">
                        <h2 class="inline-title"><?php echo sprintf($translate->_("%s Tasks") , ucfirst($task_type)); ?></h2>
                        <div>
                            <div class="tabbable" style="height: 45px;">
                                <ul class="nav nav-pills">
                                    <li class="active">
                                        <a class="task-tab" href="#tab-<?php echo $task_type; ?>-outstanding-tasks" data-toggle="tab"><?php echo $translate->_("Outstanding"); ?>
            ...
            <div class="tab-pane" id="evaluation-reports">
                ...
                <ul>
                    <li><a href="<?php echo ENTRADA_URL; ?>/admin/assessments/reports?section=rotation-evaluations"><?php echo $translate->_("Rotation Evaluations"); ?></a></li>
                    <li><a href="<?php echo ENTRADA_URL; ?>/admin/assessments/reports?section=learning-event-evaluations"><?php echo $translate->_("Learning Event Evaluations"); ?></a></li>
                    <li><a href="<?php echo ENTRADA_URL; ?>/admin/assessments/reports?section=faculty-reports"><?php echo $translate->_("Faculty Reports"); ?></a></li>
                    <li><a href="<?php echo ENTRADA_URL; ?>/admin/assessments/reports?section=course-reports"><?php echo $translate->_("Course Reports"); ?></a></li>
                </ul>
                ...
                <ul>
                    ...
                    <li><a href="<?php echo ENTRADA_URL; ?>/admin/assessments/reports?section=learner-reports"><?php echo $translate->_("Learner Reports"); ?></a></li>
