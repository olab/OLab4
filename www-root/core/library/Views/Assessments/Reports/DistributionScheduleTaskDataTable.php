 ...
 *
 * Displays a summary of distribution schedule tasks.
 *
 ...
 *
 */
class Views_Assessments_Reports_DistributionScheduleTaskDataTable extends Views_Assessments_Base
{
    /**
                            ...
                            var table = jQuery('#distribution-schedule-datatable').DataTable(
                                {
                                    ...
                                    'order': [[6, 'asc']],
                                    'oLanguage': {
                                        'sEmptyTable': '". $translate->_("There were no tasks found.") ."',
                                        'sZeroRecords': '". $translate->_("There were no tasks found.") ."'
                                    },
                                    'dom': 'Blfrtip',
                                    'buttons': [
                                        {
        ...
        <div class="row-fluid">
            <table id="distribution-schedule-datatable" class="table table-striped table-bordered">
                ...
                <tr>
                    ...
                    <th><?php echo $translate->_("Completion Status"); ?></th>
                </tr>
                </thead>
                <tbody>
                </tbody>
