...
class Views_Exam_Question_Bank_Folder_Author extends Views_Deprecated_Base
{
    ...
    protected $table_name = "exam_question_bank_folder_authors";
    protected $primary_key = "efauthor_id";
    protected $default_sort_column = "`exam_question_bank_folder_authors`.`efauthor_id`";
    protected $joinable_tables = array();
    protected $author;

    public function __construct(Models_Exam_Question_Bank_Folder_Authors $author) {
        $this->author = $author;
    }
    ...
    public static function renderTypeUL($type, $authors) {
        global $translate;
        ...
        if (isset($authors) && is_array($authors) && !empty($authors)) {
            ...
            foreach ($authors as $item) {
                ...
                if (isset($author) && is_object($author)) {
                    $author_view = new Views_Exam_Question_Bank_Folder_Author($author);
