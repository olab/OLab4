...
/**
 * XXX: Needed an Entrada_GettableTrait that implements these functions so you
 * don't have to implement these functions for every injectable class.
 */
interface Entrada_IGettable {
