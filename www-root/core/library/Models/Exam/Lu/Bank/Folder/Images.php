...
class Models_Exam_Lu_Bank_Folder_Images extends Models_Base {
    protected $image_id, $file_name, $color, $order, $deleted_date;

    protected static $table_name = "exam_lu_bank_folder_images";
    ...
    /* @return ArrayObject|Models_Exam_Lu_Bank_Folder_Images[] */
