 ...
 *
 *  A Model to handle exam folder organisations
 *
...
class Models_Exam_Bank_Folder_Organisations extends Models_Base {
    protected $folder_org_id,
        $folder_id,
        $organisation_id,
        $updated_date,
        $updated_by,
    ...
    protected static $table_name = "exam_bank_folder_organisations";
    ...
    /* @return bool|Models_Exam_Bank_Folder_Organisations */
    ...
    /* @return ArrayObject|Models_Exam_Bank_Folder_Organisations[] */
