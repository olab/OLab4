...
class Models_Assessments_Distribution_Target_ReportReleases extends Models_Base {

    protected $adt_report_release_id;
    ...
    protected static $table_name = "cbl_assessment_distribution_target_report_releases";
    protected static $primary_key = "adt_report_release_id";
    protected static $default_sort_column = "adt_report_release_id";
    ...
    public function getID() {
        return $this->adt_report_release_id;
    }

    public function getAdtReportReleaseID() {
        return $this->adt_report_release_id;
    }

    public function setAdtReportReleaseID($adt_report_release_id) {
        $this->adt_report_release_id = $adt_report_release_id;
    ...
    public function setCommentOptions($comment_options) {
        $this->comment_options = $comment_options;
    }
    ...
    public static function fetchRowByID($adt_report_release_id) {
        $self = new self();
        return $self->fetchRow(array(
            array("key" => "adt_report_release_id", "method" => "=", "value" => $adt_report_release_id)
        ));
    }

    public static function fetchAllRecords() {
        $self = new self();
        return $self->fetchAll(array(array("key" => "adt_report_release_id", "method" => ">=", "value" => 0)));
    }
