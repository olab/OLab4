...
if(!defined("PARENT_INCLUDED")) {
    ...
    if (!$ERROR) {
        ...
        $cbme_progress_api = new Entrada_CBME_Visualization(array(
            ...
            "filters" => $_GET,
            "query_limit" => 12,
            "limit_dataset" => array("items", "item_count", "filtered_item_count", "course_epas", "roles", "course_milestones", "course_assessment_tools", "rating_scales", "filter_list_data", "course_stages", "unread_assessment_count"),
            "courses" => $courses,
        ...
        if ($learner) {
            ...
            $cbme_items_view->render(array(
                ...
                "filtered_count" => $dataset["filtered_item_count"],
                ...
                "form_action_url" => ENTRADA_URL . "/assessments/learner/cbme/items?proxy_id=" . html_encode($PROCESSED["proxy_id"] ? $PROCESSED["proxy_id"] : $ENTRADA_USER->getActiveId()),
                "form_reset_url" => ENTRADA_URL . "/assessments/learner/cbme/items?proxy_id=" . html_encode($PROCESSED["proxy_id"] ? $PROCESSED["proxy_id"] : $ENTRADA_USER->getActiveId()),
