...
if((!defined("PARENT_INCLUDED")) || (!defined("IN_ANNUAL_REPORT"))) {
	...
	switch($STEP) {
		case 2 :
			...
			if(!$ERROR) {
				...
				if($db->AutoExecute(DATABASE_NAME.".ar_graduate_teaching", $PROCESSED, "INSERT")) {
	...
	switch($STEP) {
		...
		default :
			...
			?>
			<form action="<?php echo ENTRADA_URL; ?>/annualreport/education?section=add_graduate&amp;step=2" method="post">
