...
if((!defined("PARENT_INCLUDED")) || (!defined("IN_ANNUAL_REPORT"))) {
			...
			if(!$ERROR) {
				...
				if($db->AutoExecute("ar_profile", $PROCESSED, "INSERT")) {
					$EVENT_ID = $db->Insert_Id();
						...
						$SUCCESS++;
						$SUCCESSSTR[]  = "You have successfully added an <strong>Activity Profile for ".html_encode($PROCESSED["year_reported"])."</strong> to the system.<br /><br />".$msg;
						$ONLOAD[]		= "setTimeout('window.location=\\'".$url."\\'', 5000);";

						application_log("success", "Activity Profile [".$EVENT_ID."] added to the system.");					

				} else {
					$ERROR++;
					$ERRORSTR[] = "There was a problem inserting this record into the system. The MEdTech Unit was informed of this error; please try again later.";

					application_log("error", "There was an error inserting an Activity Profile record. Database said: ".$db->ErrorMsg());
				}
			} else {
				$STEP = 1;
			}
	...
	switch($STEP) {
		...
		default :
			...
			?>
			<form action="<?php echo ENTRADA_URL; ?>/annualreport/activityprofile?section=add_profile&amp;step=2" method="post">
			<table style="width: 100%" cellspacing="0" cellpadding="2" border="0" summary="Adding Activity Profile">
			<colgroup>
				<col style="width: 3%" />
				<col style="width: 37%" />
				<col style="width: 60%" />
			...
			<tr>
				...
				value="<?php echo (html_encode($PROCESSED["education"]) == '' ? "0.00" : html_encode($PROCESSED["education"])); ?>" maxlength="6" style="width: 50px" /></td>
			</tr>
			<tr>
				<td></td>
				...
				value="<?php echo (html_encode($PROCESSED["research"]) == '' ? "0.00" : html_encode($PROCESSED["research"])); ?>" maxlength="6" style="width: 50px" /></td>
			</tr>
			<tr>
				<td></td>
				...
				value="<?php echo (html_encode($PROCESSED["service"]) == '' ? "0.00" : html_encode($PROCESSED["service"])); ?>" maxlength="6" style="width: 50px" /></td>
			</tr>
			<tr>
				<td></td>
				<td style="vertical-align: top"><label for="total" class="form-required">% Total</label></td>
				<td><input type="text" id="total" name="total" readonly value="<?php echo (html_encode($PROCESSED["total"]) == '' ? "0.00" : html_encode($PROCESSED["total"])); ?>" maxlength="6" style="width: 50px" /></td>
			</tr>
			<tr>
				<td colspan="3">&nbsp;</td>
			</tr>
			...
			<tr>
				...
				<option value=""></option>
				<?php
					echo "<option value=\"Yes\"".(($PROCESSED["consistent"] == "Yes") ? " selected=\"selected\"" : "").">Yes</option>\n";	
					echo "<option value=\"No\"".(($PROCESSED["consistent"] == "No") ? " selected=\"selected\"" : "").">No</option>\n";
					echo "</select>";
				?>
				</td>				
			</tr>
			<tr>
				...
				<td><textarea id="consistent_comments" name="consistent_comments" style="width: 95%" rows="4"><?php echo html_encode($PROCESSED["consistent_comments"]); ?></textarea></td>				
			</tr>
			<tr>
				<td colspan="3">&nbsp;</td>
			</tr>
			...
			<tr>
				...
				<option value=""></option>
				<?php
					echo "<option value=\"Yes\"".(($PROCESSED["career_goals"] == "Yes") ? " selected=\"selected\"" : "").">Yes</option>\n";	
					echo "<option value=\"No\"".(($PROCESSED["career_goals"] == "No") ? " selected=\"selected\"" : "").">No</option>\n";
					echo "</select>";
				?>
				</td>				
			</tr>
			<tr>
				...
				<td><textarea id="career_comments" name="career_comments" style="width: 95%" rows="4"><?php echo html_encode($PROCESSED["career_comments"]); ?></textarea></td>				
			</tr>
			<tr>
				<td colspan="3">&nbsp;</td>
			</tr>
			<tr>
				<td></td>
				<td style="vertical-align: top"><label for="comments" class="form-nrequired">Additional Comments (Faculty members may append to the annual report any additional information they deem pertinent)</label></td>
			...
			<tr>
				...
				<td>
				<?php
					if($PROCESSED["report_completed"] == "yes")
					{
					...
					elseif($PROCESSED["report_completed"] == "no")
					{
	...
	switch($STEP) {
		...
		default :	
			...
			<tr>
				...
				value="<?php echo (html_encode($PROCESSED["clinical"]) == '' ? "0.00" : html_encode($PROCESSED["clinical"])); ?>" maxlength="6" style="width: 50px" /></td>
			</tr>
			<tr>
				<td></td>
				...
				value="<?php echo (html_encode($PROCESSED["combined"]) == '' ? "0.00" : html_encode($PROCESSED["combined"])); ?>" maxlength="6" style="width: 50px" /></td>
			</tr>
			<tr>
				<td></td>
				<td style="vertical-align: top"><label for="percentage_service" class="form-required">% Service / Administration</label></td>
			...
			<tr>
				...
				<td><input type="text" id="hospital_hours" name="hospital_hours" value="<?php echo html_encode($PROCESSED["hospital_hours"]); ?>" maxlength="6" style="width: 50px" /></td>
			</tr>
			<tr>
				<td></td>
				<td style="vertical-align: top"><label for="on_call_hours" class="form-required">Average On-Call Hours / Week</label></td>
				<td><input type="text" id="on_call_hours" name="on_call_hours" value="<?php echo html_encode($PROCESSED["on_call_hours"]); ?>" maxlength="6" style="width: 50px" /></td>
			</tr>
			<tr>
				<td colspan="3">&nbsp;</td>
			</tr>
				...
				<?php
					...
					if(isset($PROCESSED["roles"])) {
						foreach($profileRoleArray as $profileRoleListValue) {
							echo "<option value=\"".$profileRoleListValue["profile_role"]."\"".(in_array($profileRoleListValue["profile_role"], $PROCESSED["roles"]) ? " selected=\"selected\"" : "").">".html_encode($profileRoleListValue["profile_role"])."</option>\n";
						}
					} else {
						foreach($profileRoleArray as $profileRoleListValue) {
							echo "<option value=\"".$profileRoleListValue["profile_role"]."\">".html_encode($profileRoleListValue["profile_role"])."</option>\n";
						}
					}
					echo "</select>";					
				?>
			...
			<tr>
				...
				<option value=""></option>
				<?php
					echo "<option value=\"Yes\"".(($PROCESSED["roles_compatible"] == "Yes") ? " selected=\"selected\"" : "").">Yes</option>\n";	
					echo "<option value=\"No\"".(($PROCESSED["roles_compatible"] == "No") ? " selected=\"selected\"" : "").">No</option>\n";
					echo "</select>";
				?>
				</td>				
			</tr>
			...
			<tr>
				...
				<td><textarea id="roles_comments" name="roles_comments" style="width: 95%" rows="4"><?php echo html_encode($PROCESSED["roles_comments"]); ?></textarea></td>				
			</tr>
			<tr>
				<td colspan="3">&nbsp;</td>
			</tr>
			...
			<tr>
				...
				<td><textarea id="education_comments" name="education_comments" style="width: 95%" rows="4"><?php echo html_encode($PROCESSED["education_comments"]); ?></textarea></td>				
			</tr>
			<tr>
				<td></td>
				<td style="vertical-align: top"><label for="research_comments" class="form-nrequired">Research / Scholarship</label></td>
				<td><textarea id="research_comments" name="research_comments" style="width: 95%" rows="4"><?php echo html_encode($PROCESSED["research_comments"]); ?></textarea></td>				
			</tr>
			
			<tr>
				<td></td>
				<td style="vertical-align: top"><label for="clinical_comments" class="form-nrequired">Clinical Activity</label></td>
				<td><textarea id="clinical_comments" name="clinical_comments" style="width: 95%" rows="4"><?php echo html_encode($PROCESSED["clinical_comments"]); ?></textarea></td>				
			</tr>
			
			<tr>
				<td></td>
				<td style="vertical-align: top"><label for="service_comments" class="form-nrequired">Service / Administration</label></td>
				<td><textarea id="service_comments" name="service_comments" style="width: 95%" rows="4"><?php echo html_encode($PROCESSED["service_comments"]); ?></textarea></td>				
			</tr>
			<tr>
				<td colspan="3">&nbsp;</td>
			</tr>
