 ...
 *
 * This section is a secure wrapper which loads the exam confirmation interface
 *
...
if (isset($_GET["exam_progress_id"]) && $tmp_input = clean_input($_GET["exam_progress_id"], "int")) {
    ...
    if ($exam_progress) {
        ...
        if ($exam_post) {
            ...
            if (true === $grant_access) {
                ...
                require_once(ENTRADA_ABSOLUTE . "/core/modules/public/exams/confirmation.inc.php");
            } else {
                echo display_error();
