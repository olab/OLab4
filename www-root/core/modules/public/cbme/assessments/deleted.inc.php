...
if(!defined("PARENT_INCLUDED")) {
    ...
    $cbme_progress_api = new Entrada_CBME_Visualization(array(
        ...
        "filters" => $_GET,
        "query_limit" => 12,
        "limit_dataset" => array("deleted_assessments", "deleted_assessments_count", "unread_assessment_count", "filtered_assessment_count", "course_epas", "roles", "course_milestones", "course_assessment_tools", "rating_scales", "filter_list_data", "course_stages"),
        "courses" => $courses,
    ...
    $cbme_assessments_view->render(array(
        ...
        "total_count" => $dataset["deleted_assessments_count"],
        "filtered_count" => $dataset["deleted_assessments_count"],
        ...
        "form_action_url" => ENTRADA_URL . "/cbme/assessments/deleted",
        "form_reset_url" => ENTRADA_URL . "/cbme/assessments/deleted",
