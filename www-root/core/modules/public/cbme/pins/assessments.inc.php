...
if(!defined("PARENT_INCLUDED")) {
    ...
    $cbme_progress_api = new Entrada_CBME_Visualization(array(
        ...
        "filters" => $_GET,
        "query_limit" => 12,
        "limit_dataset" => array("assessment_pins", "items", "total_pinned_assessment_count", "filtered_pinned_assessment_count", "total_assessment_count", "pinned_item_count", "pinned_assessment_count", "filtered_assessment_count", "filtered_item_count", "course_epas", "roles", "course_milestones", "course_assessment_tools", "rating_scales", "filter_list_data", "course_stages", "unread_assessment_count"),
        "courses"  => $courses,
    ...
    $cbme_assessments_view->render(array(
        ...
        "form_action_url" => ENTRADA_URL . "/cbme/pins/assessments",
        "form_reset_url" => ENTRADA_URL . "/cbme/pins/assessments",
