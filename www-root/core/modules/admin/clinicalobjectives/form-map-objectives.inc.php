...
if ((!defined("PARENT_INCLUDED")) || (!defined("IN_ROTATION_SCHEDULE"))) {
    ...
    if ($PROCESSED["schedule_id"]) {
        ...
        if ($schedule) {
            ...
            $BREADCRUMB[] = array("url" => ENTRADA_URL . "/admin/clinical#/clinical/rotationschedule/drafts/" . $draft->getID() . "/rotations", "title" => "Edit Draft");
        }
    }

    $BREADCRUMB[] = array("title" => $translate->_("Map Objectives"));
