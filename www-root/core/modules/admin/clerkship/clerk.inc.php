...
if ((!defined("PARENT_INCLUDED")) || (!defined("IN_CLERKSHIP"))) {
    ...
    if (isset($_GET["ids"]) && $PROXY_ID = clean_input($_GET["ids"], "int")) {
                ...
                <div class="tab-page" id="schedule">
                    ...
                    <div class="row-fluid space-below">
                        <div class="pull-right">
                            ...
                            <a href="<?php echo ENTRADA_URL."/admin/clerkship/electives?section=add_core&ids=".$PROXY_ID;?>" class="btn btn-success"><i class="icon-plus-sign icon-white"></i> Add Core Rotation</a>
                        </div>
                    </div>
                    ...
                    <table class="tableList" cellspacing="0" summary="List of Clerkship Services">
                        ...
                        foreach ($results as $result) {
                            ...
                            if ($result["event_type"] == "elective") {
                                switch ($result["event_status"]) {
                                    case "approval":
                                        ...
                                        $click_url = ENTRADA_RELATIVE . "/admin/clerkship/electives?section=edit&id=" . $result["event_id"];
                                        $skip = false;
                                    break;
                                    case "published":
                            ...
                            if (!$skip) {
                                ...
                                echo "    <td class=\"modified\"><a href=\"" . $click_url . "\"><img src=\"" . ENTRADA_RELATIVE . "/images/" . (($apartment_available) ? "housing-icon-small.gif" : "pixel.gif") . "\" width=\"16\" height=\"16\" alt=\"" . (($apartment_available) ? "Detailed apartment information available." : "") . "\" title=\"" . (($apartment_available) ? "Detailed apartment information available." : "") . "\" /></a></td>\n";
                                echo "    <td class=\"type\"><a href=\"" . $click_url . "\">" . (($elective) ? "Elective" . (($elective_word != "") ? " (" . $elective_word . ")" : "") : "Core Rotation") . "</a></td>\n";
                                echo "    <td class=\"date-smallest\"><a href=\"" . $click_url . "\">" . date("D M d/y", $result["event_start"]) . "</a></td>\n";
                                echo "    <td class=\"date-smallest\"><a href=\"" . $click_url . "\">" . date("D M d/y", $result["event_finish"]) . "</a></td>\n";
                                echo "    <td class=\"region\"><a href=\"" . $click_url . "\">" . html_encode((($result["city"] == "") ? limit_chars(($result["region_name"]), 30) : $result["city"])) . "</a></td>\n";
                                echo "    <td class=\"title\">";
                                echo "      <a href=\"" . $click_url . "\">" . limit_chars(html_decode($event_title), 75) . "</a>";
                                echo "    </td>\n";
                                echo "</tr>\n";
                            }
                        }
        ...
        add_error("You must provide a valid <strong>User ID</strong> to view.");
