...
if((!defined("PARENT_INCLUDED")) || (!defined("ADMIN_OBSERVERSHIP_FORM"))) {
	exit;
		...
		<table style="width: 100%" cellspacing="0" cellpadding="2" border="0">
			...
			<tfoot>
				...
				<tr>
					<td>&nbsp;</td>
					<td colspan="2">
						<input name="read" type="checkbox" value="1" id="read"><label for="read" style="vertical-align:middle;font-weight:bold;"> Yes, I have read and agree to the procedures and regulations of the Student Observership policy.</label>
					</td>
				</tr>				
				<?php } ?>
				<tr>
