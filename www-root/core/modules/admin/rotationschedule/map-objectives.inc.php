...
if ((!defined("PARENT_INCLUDED")) || (!defined("IN_ROTATION_SCHEDULE"))) {
    ...
    ?>
    <div class="clearfix">
        <h1 id="mapping-main-title" class="mapping-main-title"><?php echo $translate->_("Rotation Schedule"); ?></h1>
        <?php
        ...
        $url = ENTRADA_URL . "/admin/rotationschedule?section=edit-draft&draft_id=" . $SCHEDULE->getDraftID();
        ?>
