...
if ((!defined("PARENT_INCLUDED")) || (!defined("IN_ASSESSMENTS"))) {
    ...
    $BREADCRUMB[] = array("url" => "", "title" => $translate->_("Learning Event Feedback Forms Report"));
    $HEAD[] = "<script type=\"text/javascript\">var ENTRADA_URL = '" . ENTRADA_URL . "';</script>";
    $JQUERY[] = "<script type=\"text/javascript\" src=\"" . ENTRADA_URL . "/javascript/assessments/reports/learning-event-feedback-evaluations.es6.js?release=" . html_encode(APPLICATION_VERSION) . "\"></script>";
    ...
    <script type="text/javascript">
        jQuery(function($) {
            ...
            $("#select_eventtype_btn").advancedSearch({
                api_url : "<?php echo ENTRADA_URL . "/admin/assessments?section=api-assessment-reports"; ?>",
                resource_url: ENTRADA_URL,
                filters : {
                    eventtype : {
                        label : "<?php echo $translate->_("Events Types"); ?>",
                        data_source : "get-user-learning-event-types",
                        mode: "checkbox"
                    }
                },
            ...
            $("#select_event_btn").advancedSearch({
                api_url : "<?php echo ENTRADA_URL . "/admin/assessments?section=api-assessment-reports"; ?>",
                resource_url: ENTRADA_URL,
                filters : {
                    event : {
                ...
                no_results_text: "<?php echo $translate->_("No learning events found matching the search criteria."); ?>",
                parent_form: $("#report-form"),
                width: 350,
                select_all_enabled : true
            });
    ...
    <h1><?php echo $translate->_("Learning Event Feedback Forms Report"); ?></h1>
    <div id="msgs">
        <?php
    ...
    <form class="form-horizontal" id="report-form">
        <div class="control-group space-above" id="select_course_div">
            ...
            <div class="controls">
                <a href="#" id="select_course_btn" data-control="course" class="report-control btn" type="button"><?php echo $translate->_("browse_course"); ?> <i class="icon-chevron-down"></i></a>
            </div>
        </div>
        ...
        <div class="control-group">
            <label class="control-label form-required" for="select_eventtype_btn"><?php echo $translate->_("Select Events Types:"); ?></label>
            <div class="controls">
                <a href="#" id="select_eventtype_btn" data-control="eventtype" class="report-control btn" type="button"><?php echo $translate->_("Browse Events Types "); ?><i class="icon-chevron-down"></i></a>
            </div>
        </div>
        <div class="control-group hide space-above" id="select_form_div">
            ...
            <div class="controls">
                <a href="#" id="select_form_btn" data-control="form" class="report-control btn" type="button"><?php echo $translate->_("Browse Forms "); ?><i class="icon-chevron-down"></i></a>
            </div>
        </div>
        <div class="control-group hide space-above" id="select_event_div">
            <label class="control-label" for="select_event_btn"><?php echo $translate->_("Select Learning Events (Optional):"); ?></label>
            <div class="controls">
                <a href="#" id="select_event_btn" data-control="event" class="report-control btn" type="button"><?php echo $translate->_("Browse Learning Events "); ?><i class="icon-chevron-down"></i></a>
            </div>
        </div>
        <div class="control-group hide space-above" id="report_options_div" data-control="report_options">
            <div class="control-group" id="individual-event-option-subheader">
                <label class="control-label" for="individual_event_option"><?php echo $translate->_("Separate Report for Each Event:"); ?></label>
                <div class="controls">
                    <input type="checkbox" id="individual_event_option" data-control="individual_event_option" class="report-control">
                </div>
            </div>
            <div class="control-group" id="event-info-subheader">
                <label class="control-label" for="include_event_info_subheader"><?php echo $translate->_("Include Event Info Subheader:"); ?></label>
                <div class="controls">
                    <input type="checkbox" id="include_event_info_subheader" data-control="include_event_info_subheader" class="report-control" checked>
                </div>
            </div>
