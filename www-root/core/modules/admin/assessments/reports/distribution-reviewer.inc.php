...
if ((!defined("PARENT_INCLUDED")) || (!defined("IN_ASSESSMENTS"))) {
    ...
    $JQUERY[] = "<script type=\"text/javascript\" src=\"" . ENTRADA_URL . "/javascript/assessments/reports/distribution-reviewer.es6.js?release=" . html_encode(APPLICATION_VERSION) . "\"></script>";
    ...
    <script type="text/javascript">
        jQuery(function($) {
            ...
            $("#select_course_btn").advancedSearch({
                ...
                filters : {
                    course : {
                        ...
                        data_source : "get-distribution-reviewer-courses",
                        mode: "checkbox"
                    }
                },
            ...
            $("#select_target_btn").advancedSearch({
                api_url : "<?php echo ENTRADA_URL . "/admin/assessments?section=api-assessment-reports"; ?>",
                resource_url: ENTRADA_URL,
                filters : {
                    target : {
                        label : "<?php echo $translate->_("Target"); ?>",
                        data_source : "get-user-targets-for-distribution-reviewer",
                        mode: "checkbox"
                    }
                },
                no_results_text: "<?php echo $translate->_("No target(s) found matching the search criteria."); ?>",
                parent_form: $("#report-form"),
                control_class: "target-selector",
                width: 350,
                lazyload: true,
                select_all_enabled : true
            });
            ...
            $("#select_form_btn").advancedSearch({
                ...
                filters: {
                    form: {
                        ...
                        data_source: "get-distribution-reviewer-forms-for-reporting",
                        mode: "checkbox"
                    }
                },
            ...
            $("#select_distribution_btn").advancedSearch({
                ...
                filters: {
                    distribution: {
                        ...
                        data_source: "get-reviewer-distributions-for-reporting",
                        mode: "checkbox"
                    }
                },
    ...
    <h1><?php echo $translate->_("Distribution Reviewer Report"); ?></h1>
    <div id="msgs">
        <?php
    ...
    <form class="form-horizontal" id="report-form">
        ...
        <div class="control-group hide" id="select_target_div">
            <label class="control-label form-required" for="select_target_btn"><?php echo $translate->_("Select Target(s):"); ?></label>
            <div class="controls">
                <button id="select_target_btn" data-control="target" class="report-control btn" type="button"><?php echo $translate->_("Browse Target(s) "); ?><i class="icon-chevron-down"></i></button>
            </div>
        </div>
        ...
        <div class="control-group hide space-above" id="select_distribution_div">
            <label class="control-label form-required" for="select_distribution_btn"><?php echo $translate->_("Select Distributions:"); ?></label>
            <div class="controls">
