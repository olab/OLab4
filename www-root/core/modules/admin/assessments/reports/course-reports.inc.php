...
if ((!defined("PARENT_INCLUDED")) || (!defined("IN_ASSESSMENTS"))) {
    ...
    $BREADCRUMB[] = array("url" => "", "title" => $translate->_("Course Reports"));
            ...
            $("#choose-form-btn").advancedSearch({
                ...
                filters: {
                    form: {
                        ...
                        data_source: "get-course-forms-for-reporting",
                        mode: "radio"
                    }
                },
    ...
    <h1><?php echo $translate->_("Course Reports"); ?></h1>
    <div id="msgs"></div>
    <form class="form-horizontal" id="evaluation-form">
        ...
        <div class="control-group <?php echo is_null($start_date) && is_null($end_date) ? "hide" : ""; ?> " id="evaluation-search">
            <label class="control-label" for="choose-evaluation-btn"><?php echo $translate->_("Select Course:"); ?></label>
            <div class="controls">
                <a href="#" id="choose-evaluation-btn" class="btn" type="button"><?php echo $translate->_("Browse Course "); ?><i class="icon-chevron-down"></i></a>
            </div>
        </div>
