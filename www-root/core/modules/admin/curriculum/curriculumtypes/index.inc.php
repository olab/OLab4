...
if (!defined("PARENT_INCLUDED")) {
    ...
    <div class="row-fluid">
        <span class="pull-right">
            <a class="btn btn-success" href="<?php echo ENTRADA_RELATIVE; ?>/admin/curriculum/curriculumtypes?section=add&amp;org=<?php echo $ORGANISATION_ID;?>"><i class="icon-plus-sign icon-white"></i> Add Layout</a>
        </span>
    </div>
    <br />
    <?php
	...
	if ($results) {
        ?>
        <form action ="<?php echo ENTRADA_URL;?>/admin/curriculum/curriculumtypes?section=delete&amp;org=<?php echo $ORGANISATION_ID;?>" method="post">
            <ul id="selected_curriculumtypes_options">
                ...
                foreach ($results as $result) {
                    ...
                    echo "  <a href=\"".ENTRADA_RELATIVE."/admin/curriculum/curriculumtypes?section=edit&amp;org=".$ORGANISATION_ID."&amp;type_id=".$result["curriculum_type_id"]."\">".$result["curriculum_type_name"]."</a>\n";
                    echo "</li>\n";
                }
                ?>
            </ul>
        ...
        <form id="curriculum_order_form" action ="<?php echo ENTRADA_URL;?>/admin/curriculum/curriculumtypes?org=<?php echo $ORGANISATION_ID;?>" method="post">
            <div id="reorder-info">
