...
if ((!defined("PARENT_INCLUDED")) || (!defined("IN_CURRICULUM_TRACKS"))) {
    ...
    <div class="row-fluid">
        <span class="pull-right">
            <a class="btn btn-success" href="<?php echo ENTRADA_RELATIVE; ?>/admin/curriculum/curriculumtracks?section=add&amp;org=<?php echo $ORGANISATION_ID; ?>"><i class="icon-plus-sign icon-white"></i> Add Curriculum Track</a>
        </span>
    </div>
    <br />

    <form action="<?php echo ENTRADA_URL."/admin/curriculum/curriculumtracks?org=".$ORGANISATION_ID; ?>&section=delete" method="POST">
    ...
    <form id="curriculumtrack_order_form" action ="<?php echo ENTRADA_URL;?>/admin/curriculum/curriculumtracks?org=<?php echo $ORGANISATION_ID;?>" method="post">
        <div id="reorder-info">
