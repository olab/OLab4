...
if (!defined("PARENT_INCLUDED")) {
	...
	define("IN_COURSE_ENROLMENT",	true);
	...
	$BREADCRUMB[] = array("url" => ENTRADA_URL."/admin/".$MODULE."/enrolment?".replace_query(array("section" => "false", "id" => $COURSE_ID, "step" => false)), "title" => $translate->_("Enrolment"));
