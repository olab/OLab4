 ...
 *
 * This file adds an User Disclaimer for the currently active Organisation
 *
...
if (!defined("PARENT_INCLUDED") || !defined("IN_CONFIGURATION")) {
    ...
    $BREADCRUMB[]  = array("url" => ENTRADA_URL . "/admin/settings/manage/disclaimers?" . "org=" . $ORGANISATION_ID, "title" => "Add User Disclaimer");
    ...
    switch ($STEP) {
        case 2 :
            ...
            if (isset($_POST["disclaimer_issue_date"]) && ($tmp_input = clean_input($_POST["disclaimer_issue_date"], array("notags", "trim")))) {
                ...
                $disclaimer_issue_date = "";
                $PROCESSED["disclaimer_issue_date"] = $disclaimer_issue_date;
            }
            ...
            if (isset($_POST["disclaimer_expire_date"]) && ($tmp_input = clean_input($_POST["disclaimer_expire_date"], array("notags", "trim")))) {
                ...
                $disclaimer_expire_date = "";
                $PROCESSED["disclaimer_expire_date"] = $disclaimer_expire_date;
            }
            ...
            if (!$ERROR) {
                ($PROCESSED["disclaimer_issue_date"] == "" ? $PROCESSED["disclaimer_issue_date"] = NULL : false);
                ($PROCESSED["disclaimer_expire_date"] == "" ? $PROCESSED["disclaimer_expire_date"] = NULL : false);
                ...
                if ($disclaimer->insert()) {
                    if ($disclaimer_id = $disclaimer->getID()) {
                        ...
                        application_log("error", "There was an error inserting an User Disclaimer. Database said: " . $db->ErrorMsg());
                    }
                } else {
                    add_error($translate->_("There was a problem inserting this User Disclaimer into the system. The system administrator was informed of this error; please try again later."));
                    application_log("error", "There was an error inserting an User Disclaimer. Database said: " . $db->ErrorMsg());
    ...
    switch ($STEP) {
        ...
        default:
            ...
            <form class="form-horizontal" action="<?php echo ENTRADA_URL . "/admin/settings/manage/disclaimers" . "?" . replace_query(array("step" => 2)); ?>" id="disclaimer_add_form" method="post">
                ...
                <h1><?php echo $translate->_("Adding User Disclaimer"); ?></h1>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <label class="radio-table" for="upon_decline1">
                            <input value="continue" type="radio" id="upon_decline1" name="upon_decline" checked="checked"> <?php echo $translate->_("Allow them to continue anyways."); ?>
                        </label>
