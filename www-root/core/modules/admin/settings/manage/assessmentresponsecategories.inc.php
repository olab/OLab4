...
if ((!defined("PARENT_INCLUDED"))) {
    ...
    define(("IN_ASSESSMENT_RESPONSE_CATEGORIES"),	true);

    $BREADCRUMB[] = array("url" => ENTRADA_URL."/admin/settings/manage/assessmentresponsecategories?org=".$ORGANISATION_ID, "title" => $translate->_("Assessment Response Categories"));
