...
if (!defined("PARENT_INCLUDED") || !defined("IN_MEDBIQINSTRUCTIONAL")) {
    ...
    ?>
    <h1>Add Medbiquitous Instructional Method</h1>
    <?php
	...
	$BREADCRUMB[] = array("url" => ENTRADA_URL."/admin/settings/manage/medbiqinstructional?".replace_query(array("section" => "add"))."&amp;org=".$ORGANISATION_ID, "title" => "Add Medbiquitous Instructional Method");
	...
	switch ($STEP) {
		...
		default:	
			...
			?>
			<form action="<?php echo ENTRADA_URL."/admin/settings/manage/medbiqinstructional"."?".replace_query(array("action" => "add", "step" => 2))."&org=".$ORGANISATION_ID; ?>" method="post" class="form-horizontal">
