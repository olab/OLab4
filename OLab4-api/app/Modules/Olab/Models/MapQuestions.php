...
class MapQuestions extends BaseModel {
    ...
    public function MapQuestionType() {
        return $this->belongsTo('Entrada\Modules\Olab\Models\MapQuestionTypes', 'entry_type_id');
    }
    public function MapQuestionResponses() {
        return $this->hasMany('Entrada\Modules\Olab\Models\MapQuestionResponses', 'question_id');
    }
    public function MapQuestionValidation() {
        return $this->hasMany('Entrada\Modules\Olab\Models\MapQuestionValidation');
    }
