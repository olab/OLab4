...
class UserSessionTraces extends BaseModel {

    protected $table = 'user_sessiontraces';
    ...
    public function scopeLatestTrace( $query, $session_id, $offset = 0)
    {
    ...
    public function scopeCountTraces ( $query, $session_id )
    {
        $value = $query->where( 'session_id', '=', $session_id )
                       ->get()
                       ->count();
    ...
    public function UserSessions() {
        return $this->belongsTo('Entrada\Modules\Olab\Models\UserSessions');
    }
