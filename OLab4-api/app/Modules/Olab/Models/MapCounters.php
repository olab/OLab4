...
class MapCounters extends BaseModel {
    ...
    public function MapCounterRules() {
        return $this->hasMany('Entrada\Modules\Olab\Models\MapCounterRules');
    }
    ...
    public function MapNodes() {
        return $this->belongsToMany('Entrada\Modules\Olab\Models\MapNodes', 'map_node_counters', 'counter_id', 'node_id' );
    }
