 ...
 * @property string $include_4R
 * @property string $expert
 */

class WebinarUsers extends BaseModel {

    protected $table = 'webinar_users';
    protected $fillable = ['webinar_id','user_id','include_4R','expert'];
    protected $validations = ['webinar_id' => 'integer|required',
                            'user_id' => 'exists:users,id|integer|min:0|required',
                            'include_4R' => 'integer|required',
                            'expert' => 'integer|required'];
