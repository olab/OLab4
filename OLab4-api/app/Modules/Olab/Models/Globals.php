...
use Entrada\Modules\Olab\Models\BaseScopedObjectOwnerModel;
...
class Globals extends BaseScopedObjectOwnerModel {

  const DEFAULT_LOCAL_ID = 1;
  const IMAGEABLE_TYPE = "Globals";

  protected $table = 'system_globals';
