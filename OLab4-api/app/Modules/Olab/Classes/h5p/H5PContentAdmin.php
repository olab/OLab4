...
class H5PContentAdmin
{
    ...
    const PATH_SCRIPTS = H5PPlugin::PATH_SCRIPTS . 'editor/';
    const PATH_STYLES = H5PPlugin::PATH_STYLES . 'editor/';
    ...
    public function add_insert_button()
    {
        ...
        $insert_method = OLabUtilities::get_option('h5p_insert_method', 'id');
        $button_content =
    ...
    public function add_editor_assets($id = null)
    {
        ...
        $settings['editor'] = array(
            ...
            'filesPath' => H5PPlugin::get_h5p_url() . '/editor',            
            'fileIcon' => array(
