...
/**
 * OlabConstants short summary.
 *
 * OlabConstants description.
 *
 * @version 1.0
 * @author wirunc
 */
class OlabConstants
{
  const PAYLOAD_STATE_INDEX_NAME = "state";
  const OLAB_ORGANIZATION_NAME = "OLab";
  const OLAB_GROUP_NAME = "olab";
  const OLAB_DEFAULT_ACL = "";  // no access

  const RENDER_MARKUP = 0;
  const NORENDER_MARKUP = 1;
  const RENDER_MARKUP_WITH_WIKITAG = 2;
