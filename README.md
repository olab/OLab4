...
OLab is not production-grade (yet).  At this time, the OLab4 container is purely for local development or demo purposes.  ** The Docker deployment below has hard-coded passwords and is not, not, NOT intended for any publish-facing installations. **
